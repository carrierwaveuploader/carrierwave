...
### Fixed
* Fix a file being stored under a name which doesn't follow from the identifier, leaving it where a later request could never find it. Storing is now refused instead (@mshibuya)
