Feature: uploader with file storage and versions
  ...
  Scenario: store a file
    ...
    Then there should be a file at 'public/uploads/thumb/bork.txt'
    And the file at 'public/uploads/bork.txt' should be identical to the file at 'fixtures/bork.txt'
    And the file at 'public/uploads/thumb/bork.txt' should be identical to the file at 'fixtures/bork.txt'
    And the uploader should have the url '/uploads/bork.txt'
    And the uploader's version 'thumb' should have the url '/uploads/thumb/bork.txt'
  ...
  Scenario: cache a file and then store it
    ...
    And there should not be a file at 'public/uploads/thumb/bork.txt'
    When I store the file
    Then there should be a file at 'public/uploads/bork.txt'
    And there should be a file at 'public/uploads/thumb/bork.txt'
    And the file at 'public/uploads/bork.txt' should be identical to the file at 'fixtures/bork.txt'
    And the file at 'public/uploads/thumb/bork.txt' should be identical to the file at 'fixtures/bork.txt'
    And the uploader should have the url '/uploads/bork.txt'
    And the uploader's version 'thumb' should have the url '/uploads/thumb/bork.txt'
  ...
  Scenario: retrieving a file from cache then storing
    ...
    Then there should be a file at 'public/uploads/thumb/bork.txt'
    And the file at 'public/uploads/bork.txt' should be identical to the file at 'fixtures/bork.txt'
    And the file at 'public/uploads/thumb/bork.txt' should be identical to the file at 'fixtures/monkey.txt'

  Scenario: retrieving a file from store
    Given the file 'fixtures/bork.txt' is stored at 'public/uploads/bork.txt'
    Given the file 'fixtures/monkey.txt' is stored at 'public/uploads/thumb/bork.txt'
